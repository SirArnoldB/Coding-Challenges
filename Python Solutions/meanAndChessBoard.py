...
# Each query is represented as a pair of indices (i, j). For each query, perform the following operations:
    ...
    # Select the ith-smallest value among the black cells. 
        # In case of a tie, select the one with the lower row number. 
    ...
    # Find the average value of these two cells;
        ...
        # Otherwise, replace the cell of the greater value with the average rounded up to the nearest integer, and 
        # replace the cell of the smaller value with the average rounded down to the nearest integer.
